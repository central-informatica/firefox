    ...
    <div className="space-y-6 w-full animate-fadeIn">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4">
        <div className="flex gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-blue-900 mb-1">Como funciona a gerência de sites</p>
          ...
          <div className="p-12 text-center">
            <div className="flex flex-col items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Escolha uma empresa acima para gerenciar os sites</p>
              </div>
            </div>
          </div>
        ) : loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-100">
                {sites.map((item) => (
                  <tr key={item.global_urls_id} className="hover:bg-gray-50 transition-colors duration-150">
          ...
          <div className="p-12 text-center">
            <div className="flex flex-col items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Adicione sites para restringir o uso do certificado</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full animate-[slideUp_0.3s_ease-out]">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <Label htmlFor="inativo" className="text-sm font-medium text-gray-700">
                  Inativo
                </Label>
              </div>
