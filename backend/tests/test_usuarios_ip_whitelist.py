...
# ---------------------------------------------------------------------------
def _mock_admin_user(user_id=None, org_id=None):
...
def test_listar_por_empresa_non_admin_forbidden(client, db_session):
    ...
    app.dependency_overrides[check_auth] = _mock_non_admin_user()
...
def test_obter_nonexistent_returns_404(client, db_session):
    ...
    app.dependency_overrides[check_auth] = _mock_admin_user()
