...
class RegraAcessoUrlsBase(BaseModel):
    empresa_id: UUID
    grupo_id: UUID
    global_urls_id: UUID
...
class RegraAcessoUrlsCreate(RegraAcessoUrlsBase):
    """Modelo usado no POST /regras-acesso-urls"""
    pass


class RegraAcessoUrlsCreateBulk(BaseModel):
    """Modelo para criação em lote - múltiplos grupos para uma URL"""
    empresa_id: UUID
...
class RegraAcessoUrlsUpdate(BaseModel):
...
class RegraAcessoUrlsOut(RegraAcessoUrlsBase):
    regra_id: UUID
    criado_em: datetime
...
class RegraAcessoUrlsOutWithDetails(RegraAcessoUrlsOut):
    """Modelo de saida com detalhes do grupo e URL"""
